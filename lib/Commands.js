...
module.exports = {
  "Link": {
    ...
    "Commands": {
      ...
      "Link blacklist remove": {
        "Options": "<link>",
        "Description": "Removes a link from the blacklist (SERVER ONLY)"
      },
      "Link blacklist all": {
        "Options": "<true / false>",
      ...
      "Link whitelist remove": {
        "Options": "<link>",
        "Description": "Removes a link from the whitelist (SERVER ONLY)"
      },
      "Link autowarn": {
        "Options": "<true / false>",
      ...
      "Link reactions": {
        "Options": "<true / false>",
        "Description": "Disables or enables reactions"
      },
      "Link bypass": {
  ...
  "Moderation": {
    ...
    "Commands": {
      ...
      "Hackban": {
        "Options": "<userid>",
        "Description": "Bans a user who is not in the server"
      }
    }
  },
  "DBans": {
    "Description": "Shows the settings allowing you to customize what happens to users on bans.discord.id",
    "Commands": {
      "DBans": {
        "Options": "<true / false>",
  ...
  "Filter": {
    ...
    "Commands": {
      ...
      "Filter word add": {
        "Options": "<word / phrase>",
        "Description": "Adds words or parses to the word filter (You can add multiple by separating them with a |) for example word1|pharse 1|yeet|pharse 2 with more words"
      },
      "Filter word remove": {
        "Options": "<word or phrase>",
        "Description": "Removes words or parses from the word filter (You can remove multiple by separating them with a |) for example word1|pharse 1|yeet|pharse 2 with more words"
      },
      "Filter bypass": {
        "Options": "<@mention / userid / @role / rolename>",
        "Description": "Bypasses a user or role"
