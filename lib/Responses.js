...
module.exports.Cooldown_Message         =                       `Calm down! 3 seconds remaining! The timer wont reset until you stop!`;
...
let AutoMod = {};
AutoMod.DupeLimitReason                 =                       `Please calm down! (Stop spamming the same message!)`;
AutoMod.SpamLimitReason                 =                       `Please calm down! (Stop spamming!)`;
AutoMod.mentionsReason                  =                       `Please calm down! (Too many mentions!)`;
AutoMod.roleMentionsReason              =                       `Please calm down! (Too many role mentions!)`;
AutoMod.emojisReason                    =                       `Please calm down! (Too many emojis!)`;
AutoMod.antiZalgoReason                 =                       `Zalgo characters detected (If this is a false positive, please report it)`;
AutoMod.AntiDupeEnable                  =                       `I have enabled the AntiDupe module!`;
AutoMod.AntiDupeDisable                 =                       `I have disabled the AntiDupe module!`;
...
AutoMod.AntiSpamEnable                  =                       `I have enabled the AntiSpam module!`;
AutoMod.AntiSpamDisable                 =                       `I have disabled the AntiSpam module!`;
...
AutoMod.AntiModMaxMentions              = (num) =>              `I have set the max mentions to ${num} mentions!`;
...
AutoMod.AntiModMaxRoleMentions          = (num) =>              `I have set the max role mentions to ${num} role mentions!`;
...
AutoMod.AntiModMaxEmojis                = (num) =>              `I have set the max role mentions to ${num} emojis!`;
...
Warn.Removed                        = (id) =>               `Warning #${id} has been removed!`;
Warn.RemoveNotFound                 = (id) =>               `Warning #${id} was not found!`;
Warn.NoWarnsFound                   =                       `No warnings were found for this user!`;
Warn.WrongPerms                     =                       `You lack the required permissions to view others' warnings!`;
...
Warn.WarnsCleared                   = (warns) =>            `${warns} warnings were cleared!`;
Warn.kickLimit                      = (limit) =>            `I will now kick users at ${limit} warnings!`;
Warn.kickLimitZero                  =                       `I will no longer kick users!`;
Warn.banLimit                       = (limit) =>            `I will now ban users at ${limit} warnings!`;
...
AutoRole.disable                    =                       `I won't give people roles when they join!`;
