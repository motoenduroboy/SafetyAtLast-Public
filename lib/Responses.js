...
module.exports.Nope                     =                       `âŒ | Nope!`;
module.exports.ErrorOccured             =                       `An error occurred!`;
module.exports.NotAModOrHigher          =                       `You are not a mod or higher!`; // TO REMOVE / REPLACE
module.exports.ChangedTo                = (setting, data) =>    `${setting} changed to: ${data}`; // TO REMOVE / REPLACE
...
Moderation.KickLimitEnable              =                       `I have enabled KickLimit module!`;
Moderation.KickLimitDisable             =                       `I have disabled KickLimit module!`;
Moderation.BanLimitEnable               =                       `I have enabled BanLimit module!`;
Moderation.BanLimitDisable              =                       `I have disabled BanLimit module!`;
Moderation.UnBanLimitEnable             =                       `I have enabled UnBanLimit module!`;
Moderation.UnBanLimitDisable            =                       `I have disabled UnBanLimit module!`;
Moderation.HackBanLimitEnable           =                       `I have enabled HackBanLimit module!`;
Moderation.HackBanLimitDisable          =                       `I have disabled HackBanLimit module!`;
Moderation.setDelay                     = (time) =>             `I have set the delay to ${time} seconds!`;
Moderation.setLimit                     = (role, limit) =>      `I have set the limit for ${role} to ${limit}!`;
Moderation.removedLimit                 = (role) =>             `I have removed the limit for ${role}`;
Moderation.changedTo                    = (role, limit) =>      `I have changed the limit for ${role} to ${limit}!`;
Moderation.alreadyAdded                 =                       `This role is already added!`;
Moderation.doesntExsist                 =                       `That role doesnt have a limit!`;
Moderation.LimitRached                  =                       `You have reached your limit!`;
module.exports.Moderation = Moderation;

let AutoMod = {};
AutoMod.SetupApplyingSettings           =                       `I will start protecting this server with default values!`;
...
AutoMod.AntiJoinSpamEnable              =                       `I have enabled AntiJoinSpam module!`;
AutoMod.AntiJoinSpamDisable             =                       `I have disabled AntiJoinSpam module!`;
AutoMod.AntiJoinSpamDelay               = (time) =>             `I have set the delay to ${time} seconds!`;
AutoMod.AntiJoinSpamBan                 = (msgs) =>             `I will now ban people at ${msgs} joins!`;
...
AutoMod.AntiModMaxMentionsWarn           = (msgs) =>             `I will now warn people at ${msgs} messages!`;
AutoMod.AntiModMaxMentionsMute           = (msgs) =>             `I will now mute people at ${msgs} messages!`;
AutoMod.AntiModMaxMentionsKick           = (msgs) =>             `I will now kick people at ${msgs} messages!`;
AutoMod.AntiModMaxMentionsBan            = (msgs) =>             `I will now ban people at ${msgs} messages!`;
...
AutoMod.AntiModMaxRoleMentionsWarn      = (msgs) =>             `I will now warn people at ${msgs} messages!`;
AutoMod.AntiModMaxRoleMentionsMute      = (msgs) =>             `I will now mute people at ${msgs} messages!`;
AutoMod.AntiModMaxRoleMentionsKick      = (msgs) =>             `I will now kick people at ${msgs} messages!`;
AutoMod.AntiModMaxRoleMentionsBan       = (msgs) =>             `I will now ban people at ${msgs} messages!`;
...
AutoMod.AntiModMaxEmojis                = (num) =>              `I have set the mex emojis to ${num} emojis!`;
...
AutoMod.AntiZalgoEnable                 =                       `I will now scan messages for zalgo!`;
AutoMod.AntiZalgoDisable                =                       `I will not scan messages for zalgo!`;
AutoMod.AntiZalgoWarn                   = (msgs) =>             `I will now warn people at ${msgs} messages!`;
AutoMod.AntiZalgoMute                   = (msgs) =>             `I will now mute people at ${msgs} messages!`;
AutoMod.AntiZalgoKick                   = (msgs) =>             `I will now kick people at ${msgs} messages!`;
AutoMod.AntiZalgoBan                    = (msgs) =>             `I will now ban people at ${msgs} bans!`;
AutoMod.AntiZalgoDelay                  = (time) =>             `I have set the delay to ${time} seconds!`;
module.exports.AutoMod = AutoMod;

let EventMessages = {};
EventMessages.WelcomeDisable            =                       `I have disable welcome messages!`;
EventMessages.GoodbyeDisable            =                       `I have disable goodbye messages!`;
EventMessages.KickDisable               =                       `I have disable kick messages!`;
EventMessages.BanDisable                =                       `I have disable ban messages!`;
EventMessages.SetChannel                = (channel) =>          `I have set the channel to ${channel.name}`;
EventMessages.SetMessage                = (content) =>          `I have set the message to ${content}`;
EventMessages.Test                      =                       `Testing`;
...
// Logging
let Logging = {};
Logging.MissingPermission           =                       `âŒ | I'm missing permissions in the log channel! \nIf this is a bug please report it by typing '&support'`;
Logging.MissingAccess               =                       `âŒ | I'm missing access in the log channel! \nIf this is a bug please report it by typing '&support'`;
...
Logging.ChannelRemove               = (type) =>             `I will not log ${type} anymore`;
...
Logging.ImageLogWarn                =                       `Warning: For image logging to work the logging channel must be set as NSFW, this is to comply with discord TOS.`;
...
// Warn
let Warn = {};
Warn.DMMessage                      =                       `âŒ | You have been warned!`;
...
RolePersist.NoPermission            =                       `I don't have permission to manage roles!`;
