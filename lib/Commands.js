...
module.exports = {
  "Link": {
    ...
    "Commands": {
      "Link": {
        "Options": "<true / false>",
        "Description": "Enables or Disables link scanning"
      },
      "Link blacklist": {
        "Options": "<link>",
        "Description": "Adds a link to the server blacklist"
      },
      "Link blacklist remove": {
        "Options": "<link>",
        "Description": "Removes a link from the server blacklist"
      },
      "Link blacklist all": {
        "Options": "<true / false>",
        "Description": "Adds all links to the server blacklist"
      },
      "Link whitelist": {
        "Options": "<link>",
        "Description": "Adds a link to the server whitelist"
      },
      "Link whitelist remove": {
        "Options": "<link>",
        "Description": "Removes a link from the server whitelist"
      },
      "Link autowarn": {
        "Options": "<true / false>",
        "Description": "Disables or enables autowarn for link scanning"
      },
      "Link automute": {
        "Options": "<true / false>",
        "Description": "Disables or enables automute for link scanning"
      },
      "Link reactions": {
        "Options": "<true / false>",
        "Description": "Disables or enables link reactions"
      },
      "Link bypass": {
      ...
      "Link bypass clear": {
        "Options": "",
        "Description": "Clears the server bypass list"
      }
    }
  },
  "Permissions": {
  ...
  "Warn": {
    ...
    "Commands": {
      ...
      "Warn limit kick": {
        "Options": "<warns>",
        "Description": "Disables or enables autokick (0 disables)"
      },
      "Warn limit ban": {
        "Options": "<warns>",
        "Description": "Disables or enables autoban (0 disables)"
      }
    }
  },
  "Mute": {
  ...
  "Moderation": {
    ...
    "Commands": {
      ...
      "Hackban": {
        "Options": "<userid>",
        "Description": "Bans a user who is not in the server by id"
      }
    }
  },
  "DBans": {
    ...
    "Commands": {
      "DBans": {
        "Options": "<true / false>",
        "Description": "Enables or Disables the DBans module"
      },
      "DBans action": {
        "Options": "<ban / kick / mute>",
        "Description": "The action to perform when a user is on DBans"
      },
      "DBans scan": {
        "Options": "",
        "Description": "Scans the whole server and performs the DBans action specified!"
      },
      "DBans bypass": {
        "Options": "<@mention / userid / @role / rolename>",
        "Description": "Bypasses a user or role from the DBans action"
      },
      "DBans bypass remove": {
        "Options": "<@mention / userid / @role / rolename>",
        "Description": "Removes a bypassed user or role from the server bypass list"
      },
      "DBans bypass clear": {
        "Options": "",
        "Description": "Clears the server bypass list"
  ...
  "Filter": {
    ...
    "Commands": {
      "Filter": {
        "Options": "<true / false>",
        "Description": "Enables or disables the filter module"
      },
      "Filter action": {
      ...
      "Filter word add": {
        "Options": "<word / phrase>",
        "Description": "Adds words or parses to the server word filter (You can add multiple by separating them with a |) for example word1|pharse 1|yeet|pharse 2 with more words"
      },
      "Filter word remove": {
        "Options": "<word or phrase>",
        "Description": "Removes words or parses from the server word filter (You can multiple by separating them with a |) for example word1|pharse 1|yeet|pharse 2 with more words"
      },
      "Filter bypass": {
        "Options": "<@mention / userid / @role / rolename>",
        "Description": "Bypasses a user or role from the server filter"
      },
      "Filter bypass remove": {
        "Options": "<@mention / userid / @role / rolename>",
        "Description": "Removes a bypassed user or role from the server filter"
      },
      "Filter bypass clear": {
        "Options": "",
        "Description": "Clears the server bypass list"
  ...
  "Utility": {
    ...
    "Commands": {
      "Utility rolepersist": {
        "Options": "<true | false>",
        "Description": "Enables or disables role persist"
      },
      ...
      "Utility autorole": {
        "Options": "<true | false>",
        "Description": "Enables or disables autorole"
      },
      "Utility autorole add": {
        "Options": "<@role/s | rolename | roleid>",
        "Description": "Adds a role to server autorole"
      },
      "Utility autorole remove": {
        "Options": "<@role/s | rolename | roleid>",
        "Description": "Removes a role from server autorole"
      },
      "Userinfo": {
  ...
  "Other": {
    "Description": "Invite and support commands",
    "Commands": {
      "Stats": {
        "Options": "",
