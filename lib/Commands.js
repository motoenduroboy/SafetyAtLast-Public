...
module.exports = {
  ...
  "Filter": {
    ...
    "Commands": {
      ...
      "Filter word add": {
        "Options": "<word / phrase>",
        "Description": "Adds words or parses to the word filter (You can add multiple by separating them with a |) for example word1|pharse 1|yeet|phrase 2 with more words"
      },
      "Filter word remove": {
        "Options": "<word or phrase>",
        "Description": "Removes words or parses from the word filter (You can remove multiple by separating them with a |) for example word1|phrase 1|yeet|pharse 2 with more words"
      },
      "Filter bypass": {
        "Options": "<@mention / userid / @role / rolename>",
        "Description": "Bypasses a user or role"
